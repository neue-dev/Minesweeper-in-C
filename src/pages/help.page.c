 ...
 * @ Modified time: 2024-03-25 12:04:03
 * @ Description:
 * 
    ...
    case PAGE_ACTIVE_INIT:
      ...
      Page_addComponentText(this, sBodyTextComponent, sHelpContainerComponent, 0, 2, "", "",
        String_join("\n", "-", dWidth - dMargin * 2,
          ...
          "","",
          "The goal of the game is to identify all the cells with mines on them through numerical hints provided throughout the grid.",
          "","",
          "Each hint tells us how many mines are adjacent to any given cell. To indicate the presence of a mine, simply plant a flag on it.",
          "","",
